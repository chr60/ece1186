...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		Expected Completion & \parbox[t]{10cm}{April 14th}\\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		Responsibility & MBO\\ \hline
		Expected Completion & \parbox[t]{10cm}{April 12th}\\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		Responsibility & MBO\\ \hline
		Expected Completion & \parbox[t]{10cm}{April 13th}\\ \hline
		Results & Success\\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		Risks and Assumptions & \parbox[t]{10cm}{Pulling info from valid CSV file.} \\ \hline
		Responsibility & MBO\\ \hline
		Expected Completion & \parbox[t]{10cm}{April 16th}\\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		Responsibility & MBO\\ \hline
		Expected Completion & \parbox[t]{10cm}{April 19th}\\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		Responsibility & MBO\\ \hline
		Expected Completion & \parbox[t]{10cm}{April 18th}\\ \hline
		Results & Success\\ \hline
	\end{tabular}
\end{table}
